      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 animate-slide-up">
            ...
            <span className="badge-enterprise inline-block">Assessment ID: {assessmentId}</span>
          </div>

          {/* RISK SUMMARY CARD */}
          <div className="glass-card-danger p-8 mb-10 animate-slide-up animate-delay-100" style={{ boxShadow: '0 0 40px rgba(225, 29, 72, 0.18)' }}>
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <div className="bg-danger/5 border border-danger/20 rounded-lg px-4 py-3 text-center">
                    ...
                    <div className="text-xs text-secondary-text mt-1 font-medium">High</div>
                  </div>
          ...
          <section className="mb-10 animate-slide-up animate-delay-300">
            ...
            <p className="text-secondary-text text-sm mb-6 ml-4">What these vulnerabilities mean for your business</p>
            <div className="grid md:grid-cols-3 gap-4">
              {businessImpacts.map((item) => {
                const Icon = item.icon;
                return (
                  <div key={item.title} className="glass-card p-6 group transition-all duration-300 hover:border-silver/50 glow-border">
            ...
            <section className="mb-10 animate-slide-up animate-delay-400">
              ...
              <div className="space-y-3">
                {priorityFixes.map((fix) => (
                  <div key={fix.number} className="glass-card p-5 flex items-start gap-5 group hover:border-danger/40 transition-all duration-300">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-3 mb-1">
                        ...
                        <span className="font-heading font-semibold text-primary-text">{fix.title}</span>
          ...
          <section className="mb-12 animate-slide-up animate-delay-500">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="font-heading font-bold text-2xl text-primary-text">Recommended Next Steps</h2>
            </div>
            <div className="glass-card divide-y divide-border overflow-hidden">
              {defaultNextSteps.map((step, idx) => {
                const Icon = step.icon;
                return (
                  <div key={idx} className="flex items-center gap-4 px-6 py-5 group hover:bg-card-bg/50 transition-colors">
